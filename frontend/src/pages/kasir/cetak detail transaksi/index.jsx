  ...
  return (
    <Center minH={"100vh"} w={"full"} maxW={"100vw"}>
      <Box
        ...
        position={"relative"}
      >
        <Heading text="Nota Pembayaran" /> {/* memanggil komponen heading */}
        <Grid
     ...
     <Box
      ...
      >
        <Flex justify="space-between" mb={6}>
          <Text fontSize="2xl" fontWeight="bold">Nota Pembayaran</Text>
          <Text fontSize="xl"><Input
                name="tgl_transaksi"
                id="tgl_transaksi"
                borderRadius="lg"
                focusBorderColor="messenger.500"
        ...
        <Flex justify="space-between" mb={4}>
          ...
          <Text>Rp {kolomMenu.reduce((total, item) => {
                // total adalah nilai awal, item adalah nilai yang akan dihitung
                return total + item.harga;
              }, 0)}</Text>
        </Flex>
